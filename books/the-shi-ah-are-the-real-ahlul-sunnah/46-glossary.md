...
*Ghulat:* plural of *ghali*, an extremist, one whose views and/or
actions are excessive, the name of an renegade sect
...
*Hafiz*: singular of *huffaz*, one who learns and memorizes the entire
text of the Holy Qur'an by heart
...
*Khums*: one-fifth of one's savings (now paid by Shi\`a Muslims only)
...
*Shaykh*: also *syakh*, an honoring title with many meanings; literally,
...
Taqiyya: one's way of exerting precaution in order to save his life when
it is in jeopardy, Shi\`as' way of trying to survive against the
...
*Taraweeh:* prayers performed in congregation by Sunnis during the

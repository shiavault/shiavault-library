...
besides the Prophet (S), himself, viz, Ahlul Bayt, knew with all the
...
Thaqalayn that the Qur'an is with the Ahlul Bayt, and to avoid going
astray, the Muslims should be attached to these two. Later, the Ahlul
Bayt's explanations and narrations, were added to them and together with
the effect of expert religious scholars, in the past and present,
established 'Exegesis' (explanation of Qur'an) which became a science in
itself and was called 'Tafsir', commentary.
...
commentary, in which a verse or verses of Qur'an from other Surahs
rather than the Surah under discussion are mentioned as evidence or,
thereby, for strengthening the idea.

The text of these verses and also the traditions and narrations from the
holy Prophet or Ahlul Bayt (a) is printed in bolder type than the
